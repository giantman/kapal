    ...
    <>
      <section className="border-b border-black/5 bg-neutral-50">
        <div className="mx-auto grid max-w-5xl gap-10 px-6 py-20 sm:grid-cols-[220px_1fr] sm:items-center lg:py-24">
          <div className="flex aspect-square items-center justify-center bg-neutral-200">
            <span className="font-serif text-6xl text-neutral-400">
              {initials(attorney.name)}
            </span>
          </div>
          <div>
            <Link to="/firm" className="text-sm text-neutral-500 hover:text-navy">
              ← The Firm
            </Link>
            <h1 className="mt-3 font-serif text-4xl text-neutral-900 sm:text-5xl">
              {attorney.name}
            </h1>
            <p className="mt-2 font-medium text-neutral-500">{attorney.title}</p>
            <p className="mt-6 max-w-xl text-neutral-700">{attorney.summary}</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-black/5 bg-neutral-50">
        <div className="mx-auto max-w-3xl px-6 py-16 text-center lg:py-20">
          ...
          <p className="mt-3 text-neutral-500">{firmInfo.phone}</p>
